...
export const attentionTransformerTemplate: TemplateDefinition = {
  ...
  Component: ({ props, frame, fps }) => {
    ...
    return (
      <div className="w-full h-full bg-slate-950 flex flex-col justify-center items-center p-10 overflow-y-auto">
        <div className="max-w-4xl w-full text-center" style={{ opacity: s }}>
          ...
          <h2 className="text-4xl font-extrabold text-white mt-3 mb-2">{props.title}</h2>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 relative">
            ...
            {props.showFormula && (
              <div className="mt-6 pt-4 border-t border-slate-800 text-xs font-mono text-slate-400 flex justify-around flex-wrap gap-2">
                <span>Q: Query</span>
                <span>K: Key</span>
                <span>V: Value</span>
