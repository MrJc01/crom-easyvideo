...
export interface StarterDynamicArrayProps {
  badge: string;
  headline: string;
  subtitle: string;
  items: ArrayCardItem[];
...
export const starterDynamicArrayTemplate: TemplateDefinition = {
  id: 'starter-dynamic-array',
  name: 'Dynamic Grid & Feature Cards',
  ...
  schema: [
    ...
    { name: 'subtitle', label: 'Subtítulo', type: 'textarea', defaultValue: 'Cada estágio do pipeline...' },
    {
      name: 'items',
  ...
  Component: ({ props, frame, fps }: TemplateRenderProps) => {
    const p = props as StarterDynamicArrayProps;
...
export default starterDynamicArrayTemplate;
