...
export interface StarterMetricsProps {
  badge: string;
  metricValue: string;
  metricUnit: string;
  metricLabel: string;
...
export const starterMetricsTemplate: TemplateDefinition = {
  id: 'starter-metrics',
  name: 'Big Metric & KPI Stat',
  ...
  Component: ({ props, frame, fps }: TemplateRenderProps) => {
    const p = props as StarterMetricsProps;
...
export default starterMetricsTemplate;
