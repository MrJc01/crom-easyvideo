...
export interface StarterArchitectureProps {
  systemBadge: string;
...
export const starterArchitectureTemplate: TemplateDefinition = {
  id: 'starter-architecture',
  name: 'Architecture & Flow Pipeline',
  ...
  schema: [
    ...
    { name: 'systemSubheading', label: 'Subtítulo Explicativo', type: 'textarea', defaultValue: 'Processamento distribuído...' },
  ...
  Component: ({ props, frame, fps }: TemplateRenderProps) => {
    const p = props as StarterArchitectureProps;
...
export default starterArchitectureTemplate;
